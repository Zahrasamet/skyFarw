...
export default function Page({ tour }) {
  return (
    <>
      <div className="section-banner px-[2%] sm:px-[8%] lg:px-[12%] py-[50px] lg:py-[90px] min-h-[450px] relative">
        <h2 className="text-4xl font-normal z-10 relative text-white text-center w-full unbounded-font">
          Wildness of Paris
        </h2>

        <ul className="text-white z-10 flex items-center gap-8 section-list relative">
      ...
      <div className="tour-details-container w-full flex flex-col lg:flex-row justify-between
     items-start px-[2%] sm:px-[8%] lg:px-[12%] py-[50px] gap-5 relative">
        ...
        <div className="xl:w-[70%] lg:w-[60%] w-full relative">
          ...
          <div className="tour-details-content pt-4">
            <div className="flex justify-between items-center">
              <div>
                <h2 className="text-xl sm:text-3xl font-[500] pb-0">
                  {tour.title}
                </h2>
            ...
            <p className="text-[#94a3b8] text-sm pb-2">lorem</p>
            ...
            <form className="contact-form w-full">
              <div className="w-full gap-3 flex items-center flex-col lg:flex-row mb-5">
                ...
                <div className="flex flex-col w-full">
                  <label className="pb-1 text-md font-[500]">Email:</label>
                  <input
                    type="text"
                    placeholder="Email :"
                    className="border-2 border-gray-100 outline-0 rounded-md p-2"
                ...
                <div className="flex flex-col w-full">
                  ...
                  <textarea
                    placeholder="Message :"
                    className="border-2 border-gray-100 outline-0 rounded-md p-2 h-24"
                  ></textarea>
                </div>
                <button type="submit" className="btn text-white bg-[#19355] font-bold px-6 w-full py-4
                rounded-md cursor-pointer transition-colors duration-300 mt-5">
                  <Link href="/" className="text-sm xl:text-md uppercase transition-colors duration-300 tracking-wider">
                    Send Message
                  </Link>
                </button>
